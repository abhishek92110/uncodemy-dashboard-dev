          ...
          <div className="container-fluid">
            <div className="row">
                      ...
                      <div className="media">
                        ...
                        <Link to={`/admin/Running-batches`}>
                          <div className="media-body text-white">
                            ...
                            <h3 className="text-white">
                              {totalrunningBatch && totalrunningBatch}
                            </h3>
                            {/* <div className="progress mb-2 bg-white">
                          <div
                    ...
                    <div className="card-body">
                      <div className="media">
                        ...
                        <div
                          ...
                          onClick={moveToViewFee}
                        >
                          <p className="mb-1">Fees Collection</p>
                          <h3 className="text-white">
                            {totalAmount && totalAmount.formattedFees}
                          </h3>
                          {/* <div className="progress mb-2 bg-white">
                          <div
                            className="progress-bar progress-animated bg-light"
                  ...
                  <div className="widget-stat card p-0 bg-danger">
                    <div className="card-body">
                      <div className="media">
                        ...
                        <div
                          className="media-body text-white"
                          onClick={moveToAllDemo}
                        >
                          <p className="mb-1">Total Demo</p>
                          <h3 className="text-white">
                            {allDemoList && allDemoList.length}
                          </h3>
                          {/* <div className="progress mb-2 bg-white">
                        <div
                          className="progress-bar progress-animated bg-light"
                  ...
                  <div className="widget-stat card p-0 bg-danger">
                    <div className="card-body">
                      <div className="media">
                        ...
                        <div
                          className="media-body text-white"
                          onClick={moveToNewDemo}
                        >
                          <p className="mb-1">New Demo</p>
                          <h3 className="text-white">
                            {newDemoList && newDemoList.length}
                          </h3>
                          {/* <div className="progress mb-2 bg-white">
                        <div
                          className="progress-bar progress-animated bg-light"
                  ...
                  <div className="widget-stat card p-0 bg-danger">
                    <div className="card-body">
                      <div className="media">
                        ...
                        <div
                          className="media-body text-white"
                          onClick={moveToUpcomingDemo}
                        >
                          <p className="mb-1">Upcoming Demo</p>
                          <h3 className="text-white">
                            {upcomingDemoList && upcomingDemoList.length}
                          </h3>
                          {/* <div className="progress mb-2 bg-white">
                        <div
                          className="progress-bar progress-animated bg-light"
                  ...
                  <div className="widget-stat card p-0 bg-danger">
                    <div className="card-body">
                      <div className="media">
                        ...
                        <div
                          className="media-body text-white"
                          onClick={moveToAllBatchTiming}
                        >
                          <p className="mb-1">All BatchTiming</p>
                          <h3 className="text-white">
                            {weekDaysBatch &&
                              weekDaysBatch.length + weekEndBatch.length}
                          </h3>
                          {/* <div className="progress mb-2 bg-white">
                        <div
                          className="progress-bar progress-animated bg-light"
              ...
              <div className="card-header">
                <button
                  class={`btn btn-hover btn-outline-${
                    user === "student" ? "dark" : "light"
                  }`}
                  onClick={(e) => setUser("student")}
                >
                  Student
                </button>
                <button
                  class={`btn btn-hover btn-outline-${
                    user === "register" ? "dark" : "light"
                  }`}
                  onClick={(e) => setUser("register")}
                >
                  Register Student
                </button>
                <button
                  class={`btn btn-hover btn-outline-${
                    user === "trainer" ? "dark" : "light"
                  }`}
                  onClick={(e) => setUser("trainer")}
                >
                  Trainer
                </button>
                <button
                  class={`btn btn-hover btn-outline-${
                    user === "counselor" ? "dark" : "light"
                  }`}
                  onClick={(e) => setUser("counselor")}
                >
                  Counsellor
                </button>
              </div>
                              ...
                              currentStudent.map((data, index) => {
                                ...
                                return (
                                  <tr>
                                    ...
                                    <td>
                                    {data.studentRunningBatch.length <= 1 ? (
                                      <td className="border-0">
                                        {data.studentRunningBatch[0]}
                                      </td>
                                    ) : (
                                      <select className="d-flex flex-col b-none">
                                        {data.studentRunningBatch &&
                                          data.studentRunningBatch.map((data,index) => (
                                            <option disabled selected={index===0?true:false}>
                                              {data}
                                            </option>
                                          ))}
                                      </select>
                                    ...
                                    <td className="nav-link">
                                      ...
                                      <button
                                        className="btn btn-danger text-light"
                                        onClick={(e) =>
                                          moveToStudentAttendance(
                                            null,
                                            data._id
                                          )
                                        }
                                      >
                                        <i class="fa-solid fa-clipboard-user text-light"></i>
                                      </button>
                                      <button className="btn btn-success ">
                                        <NavLink to={`AddFees/${data._id}`}>
                                          <CurrencyRupeeIcon />
                                        </NavLink>
                                      </button>
                                    </td>
                    ...
                    <div>
                      <div className="table-responsive recentOrderTable">
                        ...
                        >
                          ...
                          <tbody>
                            {currentTrainer &&
                              currentTrainer.map((Trainerdata, index) => {
                                return (
                                  <tr>
                                    ...
                                    <td>
                                      <NavLink
                                        to={`/AboutTrainer/${Trainerdata._id}`}
                                      >
                                        {" "}
                                        <button className="btn btn-success">
                                          <RemoveRedEyeIcon />
                                      ...
                                      <button
                                        className="btn btn-warning text-light"
                                        onClick={() =>
                                          showMessagedialog(Trainerdata._id)
                                        }
                                      >
                                        <MessageIcon />
                                      </button>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <button
                                        className="btn btn-primary"
                                        onClick={(e) =>
                                          moveToEditCounselor(CounselorData)
                                        }
                                      >
                                        <CreateIcon />
                                      </button>
                                      ...
                                      <button
                                        className="btn btn-warning text-light"
                                        onClick={() =>
                                          showMessagedialog(CounselorData._id)
                                        }
                                      >
                                        <MessageIcon />
                                      </button>
                    ...
                    <div>
                      <div className="table-responsive recentOrderTable">
                        ...
                        >
                          ...
                          <tbody>
                            {currentRegister &&
                              currentRegister.map((data, index) => {
                                return (
                                  <tr>
                                    ...
                                    <td>
                                      <button
                                        ...
                                        onClick={(e) =>
                                          moveToAddRegisteredStudent(data)
                                        }
                                      >
                                        <CreateIcon />
                                      </button>
